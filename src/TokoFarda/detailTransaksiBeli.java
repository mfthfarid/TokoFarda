...
public class detailTransaksiBeli extends javax.swing.JFrame {
    ...
    void getData(){
        ...
        try{
            ...
            String sql = "SELECT b.Kode_Barang, b.Nama_Barang, dtb.Jumlah, dtb.Subtotal_Barang\n" +
                         "FROM detail_transaksi_beli dtb\n" +
                         "JOIN barang b ON b.Kode_Barang = dtb.Kode_Barang\n" +
                         "WHERE dtb.Kode_TransaksiBeli ='" + session.getKodeTransaksiBeli() + "'";
    ...
    private void initComponents() {
        ...
        setTitle("Detail Transaksi Beli");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detailTransaksiBeli().setVisible(true);
            }
        });
    }
